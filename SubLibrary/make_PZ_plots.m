...
print(map_long, '-dpng', '-painters', filename)  % looks better for some reason...
% saveas(map_long, filename, 'png')
...
print(map_lat, '-dpng', '-painters', filename)  % looks better for some reason...
% saveas(map_lat, filename, 'png')
